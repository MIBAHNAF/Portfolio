...
function Projects() {
  ...
  return (
    <div id='projects' className='w-full px-4 sm:px-6 md:px-8 lg:px-[12%] py-6 md:py-10 scroll-mt-20' ref={carouselRef}>
      <h4 className='text-center mb-2 text-base sm:text-lg font-Ovo text-gray-600'>My Work</h4>
      <h2 className='text-center text-3xl sm:text-4xl md:text-5xl font-Ovo mb-10 sm:mb-16 md:mb-20 text-gray-800'>
        Projects
      </h2>
