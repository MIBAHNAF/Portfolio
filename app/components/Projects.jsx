      ...
      content: (
        <div>
          <p className="text-gray-800 dark:text-neutral-400 text-sm sm:text-base md:text-lg font-sans mb-6 sm:mb-8">
            Built a full-stack Next.js app where teachers create classes, invite students, and generate NFC tag URLs for real-time check-ins and attendance tracking.
          </p>
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <ul className="text-gray-800 dark:text-neutral-400 space-y-1 sm:space-y-2 text-sm sm:text-base">
              <li>• Implemented secure login with Firebase Auth (Google OAuth) and protected student data using Firestore security rules</li>
              <li>• Real-time attendance tracking with instant check-ins via NFC tags or direct links</li>
              <li>• Teacher dashboard for class management and student monitoring</li>
              <li>• Student portal for class enrollment and attendance history</li>
              <li>• Cross-device compatibility with NFC-enabled and non-NFC smartphones</li>
              <li>• Automated NFC link generation and attendance analytics</li>
            </ul>
          </div>
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {['Next.js', 'Firebase', 'Firestore', 'OAuth', 'NFC', 'Tailwind CSS', 'Vercel'].map((tech) => (
          ...
          <div className="grid grid-cols-2 gap-4 mb-8 min-w-0">
            <img
              src="/attendly1.png"
              alt="Attendly Teacher Dashboard"
              height="500"
              width="500"
          ...
          <div className="flex gap-3 sm:gap-4">
            <a 
              href="https://github.com/MIBAHNAF/attendly" 
              target="_blank" 
            ...
            <a 
              href="https://attendly-nine.vercel.app/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 dark:bg-blue-700 text-white font-medium rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800 hover:transform hover:scale-105 hover:shadow-md transition-all duration-300 text-sm sm:text-base"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="mb-8">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-neutral-200 mb-4">Key Features:</h4>
          ...
          <div className="mb-8">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-neutral-200 mb-4">Technologies Used:</h4>
