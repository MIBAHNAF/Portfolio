  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      flex items-center justify-between z-50'>
        <a href="#top">
          <Image src ={assets.logo} alt="" className='w-36
        cursor-pointer mr-14'/>
        </a>

        <ul className='hidden md:flex items-center gap-6 lg:gap-8
        rounded-full px-12 py-3 bg-white/50 shadow-sm'>
        ...
        px-10 py-2.5 border border-gray-500 rounded-full ml-4'>Contact <Image src={assets.arrow_icon} alt="" 
        className='w-3 font-Ovo' /></a>
