  ...
  return (
    <>
            ...
            <motion.div
              ...
              <div className="flex-shrink-0 p-4 md:p-6 lg:p-8 border-b border-gray-200 dark:border-gray-700">
                <button
                  ...
                  onClick={handleClose}>
                  <IconX className={`h-5 w-5 ${isDark ? 'text-neutral-100' : 'text-white'}`} />
                </button>
                <motion.p
      ...
      <motion.button
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-0 z-30 h-full bg-gradient-to-b from-black/70 via-black/30 to-transparent" />
